...
LABEL maintainer="Walter Doekes <wjdoekes+nrcradiant@osso.nl>"
LABEL dockerfile-vcs=https://github.com/wdoekes/nrcradiant-deb
...
# ubuntu, ubu, focal, nrcradiant, 1.5.0, '', 0wjd0
...
RUN git clean -dfx \
    ...
    # (TODO: remove ignores for stuff we don't have in netradiant-custom)
    # (reproducible tar, with 1970 timestamps, sorted, etc..)
    cd .. && \
    find netradiant-custom '!' '(' \
